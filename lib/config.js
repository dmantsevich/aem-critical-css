...
module.exports = () => {
  return {
    ...
    criticalCSS: {
      ...
      useAPIService: 'ui.apps/src/main/content/jcr_root/apps/aem-critical-css/utils/AEMCriticalCSSService.js',
      minUseAPIService: true,
      destination: 'ui.apps/src/main/content/jcr_root/'
    },
    css: {
      sourceRoot: './',
